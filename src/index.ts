...
export type { Shape, Motion, Pose, Morph } from './core/ActionObject';
...
export type { Controller, ACOptions, AC2Options } from './core/Controller';
...
export { CharacterTransformer, defaultCharacterTransOptions } from './rapier/CharacterTransformer';
export type { CharacterTransOptions } from './rapier/CharacterTransformer';
export { CharacterTransformer2, defaultCharacterTrans2Options } from './rapier/CharacterTransformer2';
export type { CharacterTrans2Options } from './rapier/CharacterTransformer2';
