...
export { ObjectA3, defaultSetLightShadowOptions } from './core/ObjectA3';
export type { Dir, Transformer, TransformMode, SetLightShadowOptions } from './core/ObjectA3';
export { ActionObject, Action } from './core/ActionObject';
export type { Figure, Motion, Pose, Morph } from './core/ActionObject';
export { DefaultTransformer, StaticTransformer, SmoothTransformer, SmoothBillboardTransformer, BillboardTransformer, FollowTransformer, defaultSmoothTransformerOptions, defaultFollowTransformerOptions } from './core/Transformers';
export type { BillboardTransformerInputOptions, FollowTransformerOptions, FollowTransformerInputOptions, SmoothTransformerOptions, SmoothBillboardTransformerInputOptions } from './core/Transformers';
...
export { Text3D , initFont, defaultText3DOptions } from './core/Text3D';
export type { Text3DOptions } from './core/Text3D';
...
export { VRView, defaultVRViewOptions } from './core/VRView';
export type { VRViewOptions } from './core/VRView';
export { ARView, defaultARViewOptions } from './core/ARView';
export type { ARViewOptions } from './core/ARView';
