	...
	parse( data, path ) {
		...
		function generateVRMLTree( data ) {
			...
			if ( parser.errors.length > 0 ) {
				...
				throw Error( 'THREE.VRMLLoader2: Parsing errors detected.' );
		...
		function buildNode( node ) {
			...
			switch ( nodeName ) {
				...
				default:
					console.warn( 'THREE.VRMLLoader2: Unknown node:', nodeName );
					break;
		...
		function buildGroupingNode( node ) {
			...
			for ( let i = 0, l = fields.length; i < l; i ++ ) {
				...
				switch ( fieldName ) {
					...
					default:
						console.warn( 'THREE.VRMLLoader2: Unknown field:', fieldName );
						break;
		...
		function buildIndexedFaceSetNode( node ) {
			...
			if ( coordIndex === undefined ) {
				...
				console.warn( 'THREE.VRMLLoader2: Missing coordIndex.' );
