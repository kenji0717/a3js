// a3.DynamicCharacterTransformerとAvatarVelocityControllerのテスト
...
const trans = new a3.DynamicCharacterTransformer(obj);
obj.setTransformer(trans);
obj.setState('Idle');
obj.setPosition(0,5,3);
view.scene.add(obj);
view.setController(new a3.AvatarVelocityController(obj));
