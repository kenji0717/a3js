// KinematicCharacterTransformerとRapierTransformer(SimplePhysics)とのCollisionテスト。
...
obj1.setTransformMode('KinematicCharacter',{collisionDetection: true});
view.scene.add(obj1);
